...
export async function run(extractedText, type) {
  ...
  const prompt = `Please summarize the following text:\n\n${extractedText} in ${text},if text is unknow character rubbish then please show " there is no text to summarize. only also add a " Improvement Suggestions" in next paragraph`;
